  ...
  return (
    <div className='px-6 mt-10 py-2 w-full'>
      ...
      <div className='flex justify-evenly'>
        <div>
          ...
          <div className='w-full mt-14 py-1'>
            <div className=" flex space-x-20">
              <h1 className='font-bold text-bblue items-center'> Wallet</h1>
              <h1>Card Transaction</h1>
              <h1>Investment</h1>
              <span className='mt-'><DropDown /></span>
        ...
        <div className='mt-[85px] mx-10 px-3 py-5 w-full h-3/4 bg-white'>
            <h1 className='font-semibold text-2xl'>Activies</h1>
            <div className="grid grid-cols-2 gap-y-0 w-60 h-15 items-center mx-auto my-10">
              <div className="bg-fgray z-50  w-44 h-44 rounded-full text-center flex flex-col items-center justify-center space-y-3 mt-7">
                <p className="font-bold text-3xl mt-3  align-middle">$60.0</p>
                <p>Tax</p>
              </div>
              <div className="bg-bblue text-white w-64 h-64 rounded-full text-center flex flex-col items-center justify-center space-y-3">
                <p className="font-bold text-3xl mt-3  align-middle">$5,000</p>
                <p>Online Shop</p>
              </div>
              <div className="bg-black border-4 border-white text-white w-36 h-36 rounded-full text-center flex flex-col items-center justify-center space-y-3 -mt-16 ml-20 z-50">
                <p className="font-bold text-3xl mt-3  align-middle">$23.0</p>
                <p>Food</p>
              </div>
            </div>
